...
(function (global) {
  ...
  ProjectState.prototype._seedSampleProject = function () {
    ...
    const c2 = createColumn({
      ...
      bars: [
        { id: global.App.ColumnModel.nextId(), diameter: 20, count: 4, placement: 'corner', manualPositions: null },
        { id: global.App.ColumnModel.nextId(), diameter: 16, count: 4, placement: 'middle', manualPositions: null },
      ],
    });
    this.columns = [c1, c2];
