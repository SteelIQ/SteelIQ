...
(function (global) {
  ...
  function createColumn(overrides = {}) {
    ...
    const base = {
      ...
      // NEW: Load parameters for analysis
      loads: {
        axialFloor: 400,
        storeys: 5,
        storeyHeight: 3.0,
      ...
      // Reinforcement model
      reinforcement: global.App.createDefaultReinforcement(),

      // Bar Bending Schedule model
      bbs: global.App.createDefaultBBS(),

      // Longitudinal bar groups. Placement is a free-form tag until the
      // Phase 5 placement editor lands (corner / face / middle / custom).
      bars: [
        { id: nextId(), diameter: 16, count: 4, placement: 'corner' },
      ],
      ties: {
        diameter: 8,
        spacingMiddle: 150,
    ...
    const column = deepMerge(base, overrides);

    console.log('%c[SteelIQ]', 'color:#22c55e;font-weight:bold;', 'New Column Object:', column);
...
console.log('%c[SteelIQ]', 'color:#00d084;font-weight:bold;', 'column.js loaded');